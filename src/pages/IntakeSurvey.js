...
const s = {
  ...
  questionLabel: { fontSize: '15px', fontWeight: 500, marginBottom: '12px', lineHeight: 1.5, color: '#1C1C1C' },
  optionGrid: { display: 'flex', flexDirection: 'column', gap: '8px' },
  option: { padding: '13px 16px', borderRadius: '11px', border: '1.5px solid rgba(0,0,0,0.08)', background: '#FFFFFF', fontSize: '14px', cursor: 'pointer', color: '#1C1C1C', fontFamily: 'DM Sans, sans-serif', textAlign: 'left', transition: 'all 0.12s', lineHeight: 1.4 },
  optionOn: { padding: '13px 16px', borderRadius: '11px', border: '1.5px solid #3D5C3C', background: '#EDF3ED', fontSize: '14px', cursor: 'pointer', color: '#3D5C3C', fontFamily: 'DM Sans, sans-serif', textAlign: 'left', fontWeight: 500, lineHeight: 1.4 },
      ...
      <div style={{ ...s.content, paddingTop: '40px' }}>
        ...
        <div style={{ background: '#FFFFFF', border: '1px solid rgba(0,0,0,0.08)', borderRadius: '14px', padding: '20px', marginBottom: '20px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            {[
              ...
              <div key={i} style={{ display: 'flex', gap: '13px', alignItems: 'flex-start', paddingBottom: i < 3 ? '16px' : 0, borderBottom: i < 3 ? '1px solid rgba(0,0,0,0.06)' : 'none' }}>
        ...
        >
          ...
          <div style={{ fontSize: '13px', color: '#1C1C1C', lineHeight: 1.65, paddingTop: '1px' }}>
            I understand that Sensify is a wellness program and not a medical service, that AI insights are for informational purposes only, and that my program data may be accessed by the Sensify team to support my program.
          </div>
        </div>
