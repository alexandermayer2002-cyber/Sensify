    ...
    <div style={s.wrap}>
      ...
      <div style={s.card}>
        ...
        {prefillEmail && !success && (
          <div style={{ position: 'relative', background: '#22301F', borderRadius: '18px', padding: '22px 20px', marginBottom: '18px', overflow: 'hidden', boxShadow: '0 14px 36px rgba(34,48,31,0.25)', textAlign: 'center' }}>
