...
const s = {
  wrap: { minHeight: 'calc(100vh - 56px)', background: '#FAF8F4', padding: '24px 20px', fontFamily: 'DM Sans, sans-serif' },
  ...
  choiceBtnAlt: { flex: 1, background: 'white', color: '#1C1C1C', border: '1.5px solid rgba(0,0,0,0.12)', borderRadius: '11px', padding: '14px', fontSize: '14px', fontWeight: 500, cursor: 'pointer', fontFamily: 'DM Sans, sans-serif' },
  ...
  symptomToggle: { textAlign: 'left', background: '#FAF8F4', border: '1px solid rgba(0,0,0,0.08)', borderRadius: '10px', padding: '11px 14px', fontSize: '13px', cursor: 'pointer', fontFamily: 'DM Sans, sans-serif', color: '#1C1C1C' },
  symptomToggleActive: { background: '#EDF3ED', border: '1px solid rgba(61,92,60,0.3)', color: '#3D5C3C', fontWeight: 500 },
