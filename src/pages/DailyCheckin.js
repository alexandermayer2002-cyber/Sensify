...
const s = {
  ...
  opt: { padding: '10px 14px', borderRadius: '10px', border: '1.5px solid rgba(0,0,0,0.1)', background: '#FFFFFF', fontSize: '13px', cursor: 'pointer', fontFamily: 'DM Sans, sans-serif', color: '#1C1C1C', flex: '1 1 auto', minWidth: 'fit-content', textAlign: 'center' },
  optOn: { padding: '10px 14px', borderRadius: '10px', border: '1.5px solid #3D5C3C', background: '#EDF3ED', fontSize: '13px', cursor: 'pointer', fontFamily: 'DM Sans, sans-serif', color: '#2D6B42', fontWeight: 500, flex: '1 1 auto', minWidth: 'fit-content', textAlign: 'center' },
